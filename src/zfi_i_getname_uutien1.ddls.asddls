...
@EndUserText.label: 'Lấy tên người bán ưu tien 1'
...
define view entity ZFI_I_GETNAME_UUTIEN1 as select distinct from I_OperationalAcctgDocItem as oadi
left outer join I_Supplier as supplier on supplier.Supplier = oadi.AlternativePayeePayer
...
//I_SupplierInvoiceAPI01
{
    ...
    supplier.TaxNumber1 as Tax1,
//    concat_with_space(addr.StreetName,concat_with_space(addr.DistrictName, addr.CityName,1),1)                as Diachi1,
//    concat(addr.StreetName,concat(',',concat(addr.DistrictName,concat(',',addr.CityName)))) as Diachi1,
    case
    ...
    sagt.SupplierAccountGroup as AccountGroup1,                 
